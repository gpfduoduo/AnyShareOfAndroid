...
public class ImageSelectAdapter extends RecyclerView.Adapter<ImageSelectAdapter.MyViewHolder> {
    ...
    public ImageSelectAdapter(final Context context, final List<IInfo> list) {
        this.list.addAll(list);
        this.context = context;
    }

    public void setPictures(final List<IInfo> list){
        this.list.clear();
        this.list.addAll(list);
    }
    ...
    @Override
    public ImageSelectAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final MyViewHolder holder = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.view_pic_item, null));
        return holder;
    }

    @Override
    public void onBindViewHolder(final ImageSelectAdapter.MyViewHolder holder, int position) {
